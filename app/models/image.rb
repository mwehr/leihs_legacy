class Image < ApplicationRecord
  ...
  validate do
    errors.add(:base, _('Uploaded file must be less than 8MB')) if size >= 8_000_000
  ...
  validate do
    if not thumbnail and Image.where(target_id: target_id, target_type: 'ModelGroup').exists?
