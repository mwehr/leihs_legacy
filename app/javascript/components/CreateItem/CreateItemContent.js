...
export const CreateItemContent = createReactClass({
  ...
  _renderChildrenInfo() {
    if (this.props.createItemProps.children) {
      ...
      var childLinks = children.map(child => {
        return (
          ...
          <div className="field row emboss margin-vertical-xxs margin-right-xs">
            <div className="row padding-inset-xs">
              <div className="col1of2 padding-vertical-xs">
                <strong className="font-size-m inline-block">{_jed('Software Informationen')}</strong>
              </div>
        ...
        <div key="attachments" className="col1of2 padding-right-xs">
          <div id="attachments">
            <div className="field row emboss margin-vertical-xxs margin-right-xs">
              <div className="row padding-inset-xs">
                <div className="col1of2 padding-vertical-xs">
                  <strong className="font-size-m inline-block">{_jed('Attachments')}</strong>
                </div>
                <div className="col1of2">
                  <div className="row">
              ...
              <div className="list-of-lines even padding-bottom-xxs">{this._renderAttachmentsRows()}</div>
            </div>
          </div>
        </div>
      )
  ...
  _renderSoftwareDetail() {
    ...
    if (this._isLicense() && (this._hasTechnicalDetail() || this._hasAttachments())) {
      return _.compact([
        <div key="separator" className="separated-top margin-bottom-m" />,
        <h2 key="title" className="headline-m padding-bottom-m" style={{ clear: 'both' }}>
          Software
        </h2>,
    ...
    return (
      <div className="padding-horizontal-m">
        ...
        <form id="form">
          ...
          {RenderCreateItem._renderColumns(
            this.props.fields,
            this.props.fieldModels,
