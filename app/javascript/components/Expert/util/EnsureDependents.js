export const EnsureDependents = {
  _determineDependents(fields, selectedValue, fieldSpecific) {
    var dependents = fields.filter(field => {
      ...
      var correctDependencyValue =
        !field.visibility_dependency_value ||
        fieldSpecific._isDependencyValue(selectedValue, field.visibility_dependency_value)
  ...
  _ensureDependentsRecursive(selectedValue, fields, fieldSpecific) {
    ...
    selectedValue.dependents.forEach(dependent => this._ensureDependentsRecursive(dependent, fields, fieldSpecific))
  },
