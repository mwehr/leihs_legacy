...
class VisitRow extends React.Component {
  ...
  sendTakeBackReminder() {
    $.ajax({
      url: `/manage/${this.props.v.inventory_pool_id}/visits/${
        this.props.v.id
      }/remind`,
      method: 'POST',
      success: () => {
        ...
        {!this.state.deleted && (
          <div className="multibutton">
            <a
              ...
              href={`/manage/${this.props.v.inventory_pool_id}/users/${
                this.props.v.user_id
              }/${this.props.v.type}`}
            >
  ...
  render() {
    return (
      <div key={this.props.v.id} className="line row focus-hover-thin">
