  ...
  render() {
    return [
      ...
      <Overlay
        ...
        animation={false}
        id={`user-overlay-${this.props.id}-${this.props.visit_id}`}
        key={`user-overlay-${this.props.id}-${this.props.visit_id}`}
        placement="top"
        target={() =>
          ReactDOM.findDOMNode(this.refs[`user-${this.props.id}-${this.props.visit_id}`])
        }
      >
        <Popover
          id={`user-popover-${this.props.id}-${this.props.visit_id}`}
          key={`user-popover-${this.props.id}-${this.props.visit_id}`}
        >
