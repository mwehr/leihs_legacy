Rails.application.routes.draw do
  ...
  namespace :borrow do
    ...
    post 'reservations/change_time_range',
         to: 'reservations#change_time_range', as: 'change_time_range'
    ...
    post 'user/switch_to_delegation/:id',
         to: 'users#switch_to_delegation', as: 'user_switch_to_delegation'
  ...
  namespace :manage do
    ...
    get 'inventory_pools/:inventory_pool_id/edit',
        to: 'inventory_pools#edit', as: 'edit_inventory_pool'
    put 'inventory_pools/:inventory_pool_id',
        to: 'inventory_pools#update', as: 'update_inventory_pool'
    ...
    scope ':inventory_pool_id/' do
      ...
      post 'models/store_attachment_react',
           to: 'models#store_attachment_react', as: 'model_store_attachment_react'
      ...
      post 'items/store_attachment_react',
           to: 'items#store_attachment_react', as: 'item_store_attachment_react'
